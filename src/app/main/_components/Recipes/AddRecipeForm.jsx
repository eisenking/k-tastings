...
//                 {/* как у ингредиента: "Продукт" + статичное "Склад ..." */}
...
//                                                                         setValue(`simpleItems.${i}.collapsed`, false);
//                                                                     }}
//                                                                     amountValue={watch(`simpleItems.${i}.amountBase`)}
//                                                                     onAmountChange={(v) => {
...
//                                                                     }}
//                                                                     disabled={false}
//                                                                     invalidCategory={!!errors?.simpleItems?.[i]?.productCategory}
//                                                                     invalidProduct={!!errors?.simpleItems?.[i]?.productId}
//                                                                     invalidAmount={!!errors?.simpleItems?.[i]?.amountBase}
//                                                                 />
//                                                             ) : (
//                                                                 <>
//                                                                     {/* <PrepPicker
...
//                                 {collapsed ? null : (
//                                     <div className="mt-3 space-y-2">
//                                         {/* ✅ Один ряд (md+) / колонка (mobile):
//                                             [Категория+Ингредиент] + [Количество]
//                                         */}
