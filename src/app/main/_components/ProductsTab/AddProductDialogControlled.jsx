...
function inferMeasureFromBaseUnit(baseUnit) {
	if (baseUnit === "мл") return "volume";
	return "mass";
}

export default function AddProductDialogControlled({
	open,
	onOpenChange,
	...
	useEffect(() => {
		...
		const inferredMeasure = inferMeasureFromBaseUnit(baseUnit);
