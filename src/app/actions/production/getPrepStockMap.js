...
export async function getPrepStockMap() {
    ...
    // Берём только заготовки (recipe.type = "preparation")
    const rows = await db
        .select({
        ...
        .where(eq(RecipesTable.type, "preparation"))
